...
readonly ERROR_LANG_CODE_REQUIRED="Language code missing. Please enter a code or select a language."
readonly SUCCESS_LANG_CODE_UPDATED="Language code updated successfully: %s. Please restart the script to apply changes."
