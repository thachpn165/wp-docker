...
readonly INFO_CORE_CREATE_DOCKER_NETWORK="Creating Docker network: %s"
...
readonly STEP_REMOVE_SITE_CONTAINERS="Removing containers for website: %s"
...
readonly SUCCESS_REDIS_RUNNING="Redis container is running."
readonly STEP_core_redis_startING_CONTAINER="Starting Redis container: "
...
readonly SUCCESS_CORE_REDIS_STARTED="Redis container has been successfully started."
...
readonly WARNING_PHP_NO_EXTENSION_AVAILABLE="No available extensions to install. Please ensure you have updated to the latest version of WP Docker."
readonly PROMPT_PHP_CHOOSE_EXTENSION="Choose PHP extension to install:"
readonly ERROR_PHP_EXTENSION_NOT_SUPPORTED="Extension %s is not supported. Please choose again."
readonly ERROR_PHP_IONCUBE_NOT_SUPPORT_ARM="IonCube extension is not supported on %s architecture. Please choose again."
readonly INFO_PHP_CONTAINER_USE_ZTS="PHP container is using ZTS."
readonly INFO_PHP_CONTAINER_USE_NTS="PHP container is NOT using ZTS (NTS)."
readonly STEP_PHP_IONCUBE_CHECK_COMPATIBILITY="Checking ionCube compatibility (%s)..."
readonly WARNING_PHP_IONCUBE_NOT_COMPATIBLE="Could not find suitable IonCube Loader file: %s (PHP %s, ZTS=%s)"
...
readonly TIP_RELOAD_SHELL="To use the wpdocker command, run the following command:"
readonly SUCCESS_ALIAS_CORRECTED_PATH="The wpdocker command already exists with the correct path configuration."
readonly STEP_WAITING_DOCKER="Waiting for Docker to start..."
readonly WARNING_DOCKER_NOT_STARTED_AFTER_WAITING="Docker has not started yet. Continuing anyway..."
readonly SUCCESS_DOCKER_VOLUME_CREATED="Docker volume created successfully."
readonly STEP_DOCKER_VOLUME_CREATING="Creating Docker volume"
readonly STEP_DOKER_INSTALLING="Installing Docker"
readonly INFO_DOCKER_REMOVE_OLD_VERSION="Removing old Docker version (as recommended by Docker)."
readonly STEP_DOCKER_INSTALLING_USING_OFFICIAL_SCRIPT="Installing Docker using the official script from Docker."
readonly ERROR_DOCKER_GET_URL_FAILED="Could not download %s. Please check again."