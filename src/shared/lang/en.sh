# =============================================
# 🌐 i18n Variable Naming Convention
# ---------------------------------------------
# Use the following prefixes to categorize messages:
#
# MSG_        - General messages
# INFO_       - Informational notices (ℹ️) (ℹ️)
# SUCCESS_    - Success confirmations (✅) (✅)
# ERROR_      - Error messages (❌) (❌)
# WARNING_    - Warning alerts (⚠️) (⚠️)
# QUESTION_   - User prompts for confirmation/input (❓) (❓)
# LABEL_      - Field or UI labels
# PROMPT_     - Input prompts
# TITLE_      - Section or menu titles
# CONFIRM_    - Yes/No confirmation text
# HELP_       - Additional help instructions
# TIP_        - Hints and usage tips
# LOG_        - Messages intended for logging
#
# 📐 Variable naming convention:
#   - Use uppercase for all variable names (UPPER_SNAKE_CASE)
#   - Variable name = <PREFIX> + <SUBJECT> + _<ACTION/ATTRIBUTE>
...
# Avoid (or limit) emojis in string values as print_msg already includes appropriate emojis (misc_utils.sh)
# 📝 Tips:
#   - Subject: SITE, BACKUP, DB, DOMAIN, FILE, USER, LOG, v.v.
#   - Action/Attribute: CREATED, FAILED, NOT_FOUND, SUCCESS, REQUIRED, EXISTED, ENTER, OVERWRITE, SELECT, v.v.
#   - Separate parts with underscores
#
# 📌 Mnemonic tips:
#   <PREFIX>_<SUBJECT>_<DESCRIPTION> (UPPERCASE)
...
readonly INFO_PARAM_EXAMPLE="Example tham số"
