...
#v1.1.8-beta
readonly ERROR_LANG_NOT_SET="Language not set."
...
readonly ERROR_LANG_SET_FAILED="Language setting failed."
...
readonly ERROR_UNPACK_FAILED="File extraction failed."
readonly INFO_AVAILABLE_LANGS="Available languages:"
