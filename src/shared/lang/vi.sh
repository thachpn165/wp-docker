...
readonly STEP_ADDING_WPDOCKER_ALIAS="Alias lệnh wpdocker chưa được thêm vào shell. Đang thêm vào..."
readonly SUCCESS_RELOAD_AFTER_ADD_ALIAS="Cấu hình alias lệnh wpdocker đã được thêm vào. Hệ thống sẽ thoát lệnh và hãy chạy lại lệnh wpdocker để khởi động menu."