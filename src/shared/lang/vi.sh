...
readonly MSG_SELECT_OPTION="🔹 Nhập số tùy chọn tương ứng trên menu và Enter: "
...
readonly ERROR_DOCKER_NOT_RUNNING="Docker không hoạt động"
...
readonly INFO_CORE_CREATE_DOCKER_NETWORK="Đang tạo Docker network: %s"
...
readonly STEP_REMOVE_SITE_CONTAINERS="Đang xóa các container cho website: %s"
...
readonly WARNING_CORE_VERSION_NEW_AVAILABLE="🚀 Có phiên bản mới! Hiện tại: %s → Mới nhất: %s. Lệnh cập nhật: wpdocker core update"
...
readonly ERROR_DOMAIN_INVALID_HYPHEN="Tên miền không được bắt đầu bằng ký tự -."
...
readonly ERROR_DOMAIN_EXCEEDS_MAX_LENGTH="Tên miền không được vượt quá 253 ký tự."
readonly ERROR_DOMAIN_INVALID_FORMAT="Tên miền không hợp lệ. Hãy đảm bảo tên miền chỉ có các ký tự chữ cái, số và dấu gạch ngang."
readonly ERROR_EMAIL_EXCEEDS_MAX_LENGTH="Địa chỉ email không được vượt quá 320 ký tự."
...
readonly STEP_WORDPRESS_MIGRATION_BACKUP_BEFORE_REMOVE="Sao lưu dữ l]iệu hiện tại trước khi ghi đè"
readonly QUESTION_WORDPRESS_MIGRATION_BACKUP="Bạn có muốn sao lưu dữ liệu hiện tại trước khi ghi đè không"
readonly QUESTION_BACKUP_RESTORE_CONFIRM="Bạn có chắc chắn muốn khôi phục từ bản sao lưu này không? Dữ liệu của %s sẽ bị ghi đè!"
readonly QUESTION_BACKUP_RESTORE_DB_CONFIRM="Bạn có chắc chắn muốn khôi phục database từ bản sao lưu này không? Dữ liệu của %s sẽ bị ghi đè!"
readonly INFO_NO_OLD_BACKUPS_FOUND="Không tìm thấy bản sao lưu cũ nào. Bỏ qua bước này."
readonly INFO_OLD_BACKUP_FILES_FOUND="Đã tìm thấy bản sao lưu cũ:"
readonly CONFIRM_DELETE_OLD_BACKUPS="Bạn có chắc chắn muốn xóa các bản sao lưu cũ này không?"
...
readonly WARNING_PHP_NO_EXTENSION_AVAILABLE="Không có extension khả dụng để cài đặt. Hãy đảm bảo đã cập nhật phiên bản WP Docker mới nhất."
readonly PROMPT_PHP_CHOOSE_EXTENSION="Chọn extension PHP để cài đặt:"
readonly ERROR_PHP_EXTENSION_NOT_SUPPORTED="Extension %s không được hỗ trợ. Vui lòng chọn lại."
readonly ERROR_PHP_IONCUBE_NOT_SUPPORT_ARM="Extension ionCube không hỗ trợ trên kiến trúc %s. Vui lòng chọn lại."
readonly INFO_PHP_CONTAINER_USE_ZTS="Container PHP đang sử dụng ZTS."
readonly INFO_PHP_CONTAINER_USE_NTS="Container PHP đang KHÔNG sử dụng ZTS (NTS)."
readonly STEP_PHP_IONCUBE_CHECK_COMPATIBILITY="Đang kiểm tra tính tương thích của ionCube (%s)..."
readonly WARNING_PHP_IONCUBE_NOT_COMPATIBLE="Không tìm thấy file Ioncube Loader phù hợp: %s (PHP %s, ZTS=%s)"
...
readonly STEP_WAITING_DOCKER="Đang chờ Docker khởi động..."
readonly WARNING_DOCKER_NOT_STARTED_AFTER_WAITING="Docker vẫn chưa khởi động. Vẫn tiếp tục..."
readonly SUCCESS_DOCKER_VOLUME_CREATED="Đã tạo volume Docker thành công."
readonly STEP_DOCKER_VOLUME_CREATING="Đang tạo volume Docker"
readonly STEP_DOKER_INSTALLING="Đang cài đặt Docker"
readonly INFO_DOCKER_REMOVE_OLD_VERSION="Đang gỡ bỏ phiên bản Docker cũ (theo khuyến nghị của Docker)."
readonly STEP_DOCKER_INSTALLING_USING_OFFICIAL_SCRIPT="Đang cài đặt Docker bằng script chính thức từ Docker."
readonly ERROR_DOCKER_GET_URL_FAILED="Không thể tải về %s. Vui lòng kiểm tra lại."