...
readonly INFO_BACKUP_NO_FILES_PASSED="Không có tập tin nào được chỉ định, sẽ hiển thị danh sách chọn."
readonly ERROR_BACKUP_FOLDER_NOT_FOUND="Không tìm thấy thư mục backups trong bất kỳ site nào!"
readonly ERROR_BACKUP_NO_FILE_SELECTED="Bạn chưa chọn tập tin backup nào để upload."
readonly ERROR_RCLONE_CANNOT_DETECT_SITE="Không thể xác định site từ đường dẫn file backup."
readonly INFO_RCLONE_UPLOAD_LIST="Danh sách tập tin sẽ được upload:"
readonly INFO_RCLONE_UPLOADING="Đang tải lên: %s"
readonly SUCCESS_RCLONE_UPLOAD_SINGLE="Đã upload thành công: %s"
readonly ERROR_RCLONE_UPLOAD_FAILED_SINGLE="Lỗi khi upload: %s"
readonly SUCCESS_RCLONE_UPLOAD_DONE="Tải lên thành công toàn bộ tập tin backup."
...
readonly INFO_BACKUP_NO_FILES_PASSED="Không có tệp sao lưu nào được truyền. Đang chọn từ các tệp có sẵn..."
...
readonly ERROR_RCLONE_CONFIG_NOT_FOUND="Không tìm thấy tệp cấu hình Rclone"
...
readonly SUCCESS_NGINX_RELOADED="Đã khởi động lại nginx-proxy thành công"

readonly INFO_SSL_CERT_PATH="Đường dẫn chứng chỉ SSL: %s"
readonly INFO_SSL_KEY_PATH="Đường dẫn khóa riêng SSL: %s"
readonly ERROR_ENV_NOT_FOUND=".env không tồn tại cho website %s"
...
readonly STEP_NGINX_RELOADING="Đang reload container NGINX Proxy để áp dụng chứng chỉ..."
...
readonly SUCCESS_DOCKER_COMPOSE_INSTALLED="Cài đặt Docker Compose thành công."
...
readonly WARNING_WPCLI_NOT_FOUND="Không tìm thấy WP-CLI. Đang tải về phiên bản mới nhất..."
